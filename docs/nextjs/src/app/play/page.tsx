...
import { StepchartsPlayLayout, STEPCHARTS_AGENT } from "@/components/StepchartsPlayLayout";
...
export default function PlayPage() {
  const { threadIds, threadId, setThreadId, addNewThread, hydrated } = useStepchartsThreadIds();
